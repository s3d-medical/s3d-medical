...
public class PatientInfo {
    ...
    public void fill(com.s3d.webapps.medicalrecord.persistence.medicalrecordhomepage.patient.PatientInfo patientInfo) {
        if(patientInfo == null){
            return ;
        }
        //1basic
     ...
     * basic info
     */
    private void fillBasicInfo(com.s3d.webapps.medicalrecord.persistence.medicalrecordhomepage.patient.PatientInfo patientInfo) {
