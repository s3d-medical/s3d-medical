...
.controller("MainPageController", ["$scope", function ($scope) {
        ...
        $scope.settings = {
            ...
            sickCodes: [{id: "E10-E14", name: "糖尿病", shortcut: "TNB"}, {id: "I10.X02", name: "高血压", shortcut: "GXY"}, {id: "I11.901", name: "高血压性心脏病 NOS", shortcut: "XZB"}, {id: "X59.952", name: "骨折", shortcut: "GZ"}],
            enterTypes: [{id: "1", name: "门诊", shortcut: "MZ"}, {id: "2", name: "急诊", shortcut: "JZ"}, {id: "3", name: "其他医疗机构转入", shortcut: "QTYLJJZR"}, {id: "4", name: "其他", shortcut: "QT"}],
            enterSickStates: [{id: "1", name: "有", shortcut: "Y"}, {id: "2", name: "临床未确定", shortcut: "LCWQD"}, {id: "3", name: "情况不明", shortcut: "QKBM"}, {id: "4", name: "无", shortcut: "W"}],
            leaveTypes: [{id: "1", name: "医嘱离院", shortcut: "YZLY"}, {id: "2", name: "医嘱转院", shortcut: "YZZY"}, {id: "3", name: "医嘱转社区卫生服务机构/乡镇卫生院", shortcut: "YZZSQ"}, {id: "4", name: "非医嘱离院", shortcut: "FYZLY"}, {id: "5", name: "死亡", shortcut: "SW"}, {id: "6", name: "其他", shortcut: "QT"}],
