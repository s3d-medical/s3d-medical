...
<%@ include file="/resources/jsp/bui_edit_top.jsp"%>
	<hr>
    <form id="J_Form" action="<c:url value="/da/config/set/update" />" method="post" class="form-horizontal">
    	<input name="fdType"  type="hidden" value="${model.fdType }">
    <input type="hidden" name="fdId" value="${model.fdId}">
     <div class="control-group">
      ...
      <div class="control-group">
        <label class="control-label">${descCode}：</label>
        <div class="controls">
