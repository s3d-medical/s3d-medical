...
<link href="${WEBAPPS_Parameter_ResPath}/css/bootstrap.css" rel="stylesheet" type="text/css" />
<link href="${WEBAPPS_Parameter_ResPath}/css/select.min.css" rel="stylesheet" type="text/css" />
